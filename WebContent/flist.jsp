...
<body style="background-color: white;">
	...
	<div class="card">
		<div class="card-body">
		<form action = "${contextPath}/f" method = "get">
			<c:forEach var="p" items="${plist}">
				<div class="row">
					...
					<div class="col-md-3">
						...
						<p class="card-text">
							Name of the Facility : <span class="inner-name">${p.fname}</span>
						</p>
						<p class="card-text">
							Description : <span class="inner-name">${p.f_description}</span>
						</p>
						<p class="card-text">
							Contact Number : <span class="inner-name">${p.fcontact}</span>
						</p>
					...
					<div class="col-md-3">
<br>
						<button class=" btn btn-primary" value="${p.f_id }" name="fid">AddToFavourites</button>
						&nbsp; &nbsp; &nbsp; &nbsp;
