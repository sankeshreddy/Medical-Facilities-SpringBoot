...
<body style="background-color: white;">
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
		<!-- Brand/logo -->
		<a class="navbar-brand" href="#" style="font-family: verdana;">Medical
			Facilities</a> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<button type="button" class="btn btn-primary" data-toggle="modal"
				data-target="#Login">Welcome
				${pageContext.request.userPrincipal.name}</button>
			&nbsp &nbsp
		<a class="btn btn-primary" onclick="document.forms['logoutForm'].submit()">Logout</a>&nbsp &nbsp
	...
	<h1 align="center" style="font-family: Arial;">Details of Doctors</h1>
							...
							<div class="trainee_wrap">
								<div class="row">
									...
									<div class="col-md-4 col-sm-9">
										<h2>Name of the Doctor:</h2>
										<h2>
											<span class="inner-name"> ${p.dname}</span><br>
										</h2>
										<h2>Description:</h2>
										<h3>
											<span class="inner-name">${p.d_descrption}</span>
										</h3>
										<h2>Contact Number:</h2>

										<h3>
											<span class="inner-name">${p.dcontact}</span>
										</h3>
										<!-- <div class="right"> -->
										<div class="container">
											<div class="row">
												<div class="col text-center">
													...
													<button type="button" class="float-right; btn btn-primary"
														data-toggle="modal" data-target="#myModal">Call
														Back</button>
													<button type="button" class="float-right; btn btn-primary"
														data-toggle="modal" data-target="#myModal">Ad
														favourites</button>
