							...
							<div class="trainee_wrap">
								<div class="row">
									...
									<div class="col-md-4 col-sm-8">
										...
										<h4>
											Description : <span class="inner-name">${p.d_descrption}</span>
										</h4>
										<h4>
											Contact Number : <span style="color: blue;"
												class="inner-name">${p.dcontact}</span>
										</h4>
									...
									<div class="col-md-4 col-sm-9">
										...
										<button type="submit" class="float-right; btn btn-success;">
											<a href="fav/${p.d_id }"
												style="color: blue; text-decoration: none">Ad favourites</a>
										</button>
