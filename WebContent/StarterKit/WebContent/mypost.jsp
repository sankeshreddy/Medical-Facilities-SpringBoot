...
<body>
	...
	<div class="container">
		...
		<h1 class="text-center">My Ad Post</h1>
						...
						<div class="trainee_wrap">
							<div class="row">
								...
								<div class="col-md-4 col-sm-9">
									<h2>Doctor Name:</h2>
									<h2>
										<span class="inner-name"> ${postl.doctor_name}</span><br>
									</h2>
									<h2>Description:</h2>
									<h3>
										<span class="inner-name">${postl.description}</span>
									</h3>
									<h2>Contact Number:</h2>

									<h3>
										<span class="inner-name">${postl.phno}</span>
									</h3>

									<div class="row">
										<div class="col-sm-12 col-sm-12 text-center">
											<button type="button" class="float-right;btn btn-success">
												<a href="updatepost/${postl.aid }">Edit</a>
											</button>

											<button type="button" class="float-right;btn btn-success">
												<a href="delete?id=${postl.aid }">Delete</a>
											</button>
