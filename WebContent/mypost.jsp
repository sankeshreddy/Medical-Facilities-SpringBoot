...
<body style="background-color: white;">
	...
	<br>
	<h1 align="center" style="font-family: verdana;">Doctors Posts</h1>
			...
			<c:forEach var="postl" items="${postlist}">
				<div class="row">
					...
					<div class="col-md-4">
						...
						<p class="card-text">
							Name of the doctor : <span class="inner-name">${postl.doctor_name}</span>
						</p>
						<p class="card-text">
							Qualification : <span class="inner-name">${postl.description}</span>
						</p>
						<p class="card-text">
						...
						<p class="card-text">
							Specialization Service: <span class="inner-name">${postl.subcategory.subcategoryname}</span>
						</p>
						<hr>
					...
					<div class="col-md-4">
						...
						<button type="button" class="float-right;btn btn-primary">
							<a href="updatepost/${postl.aid }"><font color="white">Edit</font></a>
						</button>
						&nbsp;&nbsp;&nbsp;&nbsp;

						<button type="button" class="float-right;btn btn-primary">
							<a href="delete?id=${postl.aid }"><font color="white">Delete</font></a>
						</button>
