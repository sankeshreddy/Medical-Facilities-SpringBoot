...
<br>
 ...
 <div class="card-body">
  ...
  <p class="card-text" ><font color="blue">DoctorId : <span class="inner-name"> ${p.did.d_id}</font></span></p>
  <p class="card-text">Name of the Doctor : <span class="inner-name">${p.did.dname}</span></p>
  <p class="card-text">Qualification : <span class="inner-name">${p.did.d_description}</span></p>
  <p class="card-text">Contact Number : <span style="color: black;" class="inner-name">${p.did.dcontact}</span></p>
